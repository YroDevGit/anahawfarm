          ...
          <div>
            ...
            <div>
              ...
              <table>
                ...
                <td class="formfield"><input class="memf" type="text" name="location" required=""></td>
                </tr>
               
                <tr>
                <td class="formfield"><label>Suppliers: </label></td>
                <td class="formfield"><input class="memf" id="weight"  type="text" name="branch" ></td>
                </tr>
              
                <tr>
                <td class="formfield"><label>Sub Supplier </label></td>
                <td class="formfield"><input class="memf" type="text" id="price" name="production" ></td>
                </tr>

                 <tr>
                <td class="formfield"><label>Sold: </label></td>
                <td class="formfield"><input class="memf" type="number" name="sold" id="sacks" min="1"   required=""></td>
                </tr>
                
                <tr>
                <td class="formfield"><label>Status: </label></td>
                <td class="formfield">
                  <select name="status" class="memf">
                ...
                <tr>
                  <td colspan="2" align="right" class="formfield pad5"><button name="supinv" type="submit">Save</button></td>
                </tr>
              </form>
              </table>
          ...
          <div style="display: flex; float: right;padding-bottom: 10px; background-color: white;">
            <?php
              if($_SESSION['userole']!=2){
                ?>
                  <button onclick="document.getElementById('modals').style.display='';" class="ybtn main-add no-border">Add record</button>
                <?php
              }
              else{
...
<script type="text/javascript">
  ...
  function search(){
    ...
    xml.open("GET","supinvtbl.php?value="+val+"&userid="+userid);
    xml.send();
  }
