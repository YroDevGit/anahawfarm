          ...
          <div>
            ...
            <div>
              ...
              <table>
                ...
                <td class="formfield"><?php echo crops($user,"memf","f0"); ?></td>
                </tr>
                <tr>
                <td class="formfield"><label>Seeds cost: </label></td>
                <td class="formfield"><input class="memf" type="number" name="f1" value="0" min="0" max="0" required=""></td>
                </tr>
                <tr>
                <td class="formfield"><label>No. of sacks/bag: </label></td>
                <td class="formfield"><input class="memf" type="text" name="f2" required=""></td>
                </tr>
                <tr>
                <td class="formfield"><label>Fertilizer cost: </label></td>
                <td class="formfield"><input class="memf" type="text" name="f3" required=""></td>
                </tr>
                <tr>
                <td class="formfield"><label>Number of sacks/bag: </label></td>
                <td class="formfield"><input class="memf" type="text" name="f4" required=""></td>
                </tr>
                <tr>
                <td class="formfield"><label>Chemical cost: </label></td>
                <td class="formfield"><input class="memf" type="text" name="f5" required=""></td>
                </tr>
                <tr>
                <td class="formfield"><label>Number of chemicals: </label></td>
                <td class="formfield"><input class="memf" type="text" name="f6" required=""></td>
                </tr>
                <tr style="display: none;">
                <td class="formfield"><label>Production cost per hectar: </label></td>
                <td class="formfield"><input class="memf" type="text" name="f7" value="0" required=""></td>
                </tr>
                
                <tr>
                <td class="formfield"><label>Consume sack: </label></td>
                <td class="formfield"><input class="memf" type="text" name="f9" required=""></td>
                </tr>
                <tr>
                <td class="formfield"><label>Out of sack: </label></td>
                <td class="formfield"><input class="memf" type="text" name="f10" required=""></td>
                </tr>

                <tr>
                <td class="formfield"><label>Marketing income: </label></td>
                <td class="formfield"><input class="memf" type="text" name="f8" required=""></td>
                </tr>

                <tr>
                  <td colspan="2" align="right" class="formfield pad5"><button name="fbtn" type="submit">Save</button></td>
                </tr>
              </form>
              </table>
      ...
      <div>
        ...
        <div class="stitle">
          ...
          <div style="float: left;">
            <div>
              <input type="search" name="" class="searchfield" style="display: none;" id="search" placeholder="Search finance here..."  oninput="search()">
            </div>
          </div>
          <?php
            ...
            <button onclick="document.getElementById('modals').style.display='';" class="ybtn main-add no-border">Financial management</button>
          </div>
              <?php
            }
            else{
...
<script type="text/javascript">
  ...
  function search(){
    ...
    xml.open("GET","financetbl.php?value="+val+"&userid="+userid);
    xml.send();
  }
