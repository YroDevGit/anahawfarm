...
<div class="sidebar" data-color="white" data-active-color="danger">
      ...
      <div class="sidebar-wrapper" style="width: 350px; overflow: hidden;">
        <ul class="nav">
          ...
          <li class="navli" id="c12" style="display: none;">
            <a href="schedules.php">
              <i class="nc-icon nc-calendar-60"></i>
              <p>File insurance</p>
            </a>
          </li>
          <li class="navli" id="c13">
            <a href="method.php">
              <i class="nc-icon nc-calendar-60"></i>
              <p>Farming method</p>
            </a>
          </li>
          <li class="navli" id="c14">
          ...
          <li class="navli" id="c17">
            <a href="inventory.php">
              <i class="nc-icon nc-calendar-60"></i>
              <p>Crop management</p>
            </a>
          </li>
          <li class="navli" id="c31" style="display: none;">
            <a href="sales.php">
              <i class="nc-icon nc-calendar-60"></i>
          ...
          <li class="navli" id="c15">
            <a href="financial.php">
              <i class="nc-icon nc-calendar-60"></i>
              <p>Financial management</p>
            </a>
          </li>
          <li class="navli" id="c16">
            <a href="resource.php">
              <i class="nc-icon nc-calendar-60"></i>
              <p>Resource management</p>
            </a>
          </li>
          <li class="navli" id="c11" style="display: none;">
            <a href="damage.php">
              <i class="nc-icon nc-calendar-60"></i>
              <p>Notice of loss</p>
            </a>
          ...
          <li class="navli" id="c3" style="display: none;">
            <a href="schedules.php">
              <i class="nc-icon nc-calendar-60"></i>
              <p>Records</p>
            </a>
           ...
           <li id="c50" style="">
            <a href="summary.php">
              <i class="nc-icon nc-calendar-60"></i>
              <p>Sales And Expenses</p>
            </a>
          </li>

          <li class="navli" id="c60" style="">
            <a href="supinv.php">
              <i class="nc-icon nc-calendar-60"></i>
          ...
          <li class="navli" id="c50" style="">
            <a href="summary.php">
              <i class="nc-icon nc-calendar-60"></i>
              <p>Sales And Expenses</p>
            </a>
          </li>
          <li class="navli" id="c70">
            <a href="sales.php">
              <i class="nc-icon nc-calendar-60"></i>
              <p>Production Sales</p>
            </a>
