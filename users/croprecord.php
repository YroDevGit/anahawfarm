          ...
          <div>
            ...
            <div>
              ...
              <table>
                ...
                <td class="formfield"><input class="memf" type="text" name="cropp" required=""></td>
                </tr>
                <tr>
                ...
                <td class="formfield"><input class="memf" type="date" name="harvest" required=""></td>
                </tr>
                <tr>
                <td class="formfield"><label>Production harvest: </label></td>
                <td class="formfield"><input class="memf" type="text" name="prod" required=""></td>
                </tr>
                <tr>
                <td class="formfield"><label>Sack weight(Kg.): </label></td>
                <td class="formfield"><input class="memf" type="text" name="sack" required=""></td>
                </tr>

                <tr>
                  <td colspan="2" align="right" class="formfield pad5"><button name="cc" type="submit">Save</button></td>
                </tr>
              </form>
              </table>
      ...
      <div>
        ...
        <div class="stitle">
          ...
          <div style="float: left;">
            <div>
              <input type="date" name="" class="searchfield" id="search" placeholder="Search cropping here..."  oninput="search()">
            </div>
          </div>
          <div style="display: flex; float: right;padding-bottom: 10px; background-color: white;">
            <?php
              if($_SESSION['userole']!=2){
                ?>
                  <button onclick="document.getElementById('modals').style.display='';" class="ybtn main-add no-border">Add new record</button>
                <?php
              }
              else{
        ...
        <div id="inserhere">
           ...
           <div>
             <a href="actions/retrieve.php?link=croprecord.php&table=cropp&column=uzer" onclick="return confirm('are you sure to proceed?')">Retrieved deleted data</a>
           </div>
          </div>
        </div>
      </div>
...
<script type="text/javascript">
  ...
  function search(){
    ...
    xml.open("GET","croptbl.php?value="+val+"&userid="+userid);
    xml.send();
  }
