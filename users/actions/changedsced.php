...
$sq = "delete from schedetails where sched_id = '$sched'";
setQuery($sq);

$sql = "insert into schedetails values('$getCode','$sched','$farm',$user,'$date','$select','Not-set',0,0)";


$sql2 = "update scheduler set sched_stat = 1 where sched_id = '$sched'";
setQuery($sql2);
