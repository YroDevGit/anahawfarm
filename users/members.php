          ...
          <div>
            ...
            <div>
              ...
              <table>
                ...
                <td class="formfield"><input class="memf" type="text" name="fn" required=""></td>
                </tr>

                <tr>
                <td class="formfield"><label>Lastname: </label></td>
                <td class="formfield"><input class="memf" type="text" name="ln" required=""></td>
                </tr>

                <tr>
                <td class="formfield"><label>Contact: </label></td>
                <td class="formfield"><input class="memf" type="text" name="cn" required=""></td>
                </tr>

                <tr>
                <td class="formfield"><label>Address: </label></td>
                <td class="formfield"><input class="memf" type="text" name="ad" required=""></td>
                </tr>


                <tr>
                <td class="formfield"><label>Type: </label></td>
                <td class="formfield" >
                  <select style="width: 100%;height: 27px;" name="cb" required="">
                ...
                <tr>
                  <td colspan="2" align="right" class="formfield pad5"><button name="bt" type="submit">Save</button></td>
                </tr>
              </form>
              </table>
      ...
      <div>
        ...
        <div class="stitle">
          ...
          <div style="float: left;">
            <div>
              <input type="search" name="" class="searchfield" id="search" placeholder="Search members here..."  oninput="search()">
            </div>
          </div>
          <div style="display: flex; float: right;padding-bottom: 10px; background-color: white;">
            <?php
              if($_SESSION['userole']!=2){
                ?>
                <button onclick="document.getElementById('modals').style.display='';" class="ybtn main-add no-border">Add new member</button>
                <?php
              }
              else{
...
<script type="text/javascript">
  ...
  function search(){
    ...
    xml.open("GET","memtable.php?value="+val+"&userid="+userid);
    xml.send();
  }
