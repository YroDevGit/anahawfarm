          ...
          <div>
            ...
            <div>
              ...
              <table>
                ...
                <td class="formfield"><?php crops($user,'memf','r1'); ?></td>
                </tr>
                <tr>
                <td class="formfield"><label>Number of bags per hectar: </label></td>
                <td class="formfield"><input class="memf" type="number" name="r2" required=""></td>
                </tr>
                <tr>
                <td class="formfield"><label>Types of fertilizer: </label></td>
                <td class="formfield">
                  <?php getDropdown('fertilizer','memf','r3','cs') ?>
                </td>
                </tr>
                <tr>
                <td class="formfield"><label>If others please specify: </label></td>
                <td class="formfield"><input class="memf" type="text" name="r33" ></td>
                </tr>
                <td class="formfield"><label>Chemical application: </label></td>
                <td class="formfield">
                  <?php getDropdown('chemical','memf','r4','cs') ?>
                </td>
                </tr>
                <tr>
                <td class="formfield"><label>If others please specify: </label></td>
                <td class="formfield"><input class="memf" type="text" name="r44" ></td>
                </tr>
               
                <tr>
                  <td colspan="2" align="right" class="formfield pad5"><button name="rr" type="submit">Save</button></td>
                </tr>
              </form>
              </table>
      ...
      <div>
        ...
        <div class="stitle">
          ...
          <div style="float: left;">
            <div>
              <input type="search" name="" class="searchfield" id="search" placeholder="Search resource here..."  oninput="search()">
            </div>
          </div>
          <div style="display: flex; float: right;padding-bottom: 10px; background-color: white;">
            <?php
              if($_SESSION['userole']!=2){
                ?>
                  <button onclick="document.getElementById('modals').style.display='';" class="ybtn main-add no-border">Resource management</button>
                <?php
              }
              else{
...
<script type="text/javascript">
  ...
  function search(){
    ...
    xml.open("GET","resourcetbl.php?value="+val+"&userid="+userid);
    xml.send();
  }
