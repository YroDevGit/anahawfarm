...
<body class="">
<input type="hidden" name="" id="farm_id" value="<?php echo $fid; ?>">
          ...
          <div>
            ...
            <div>
              ...
              <table>
                ...
                <td class="formfield"><?php echo crops($user,"memf","crops"); ?></td>
                </tr>
                <tr>
                <td class="formfield"><label>Expense: </label></td>
                <td class="formfield"><input class="memf" type="text" name="expenses" required=""></td>
                </tr>
                <tr>
                <td class="formfield"><label>Amount: </label></td>
                <td class="formfield"><input class="memf" type="number" name="amount" required=""></td>
                </tr>
                <tr>
                <td class="formfield"><label>Datetime: </label></td>
                <td class="formfield"><input class="memf" type="datetime-local" name="datetime" required=""></td>
                </tr>   

                <tr>
                  <td colspan="2" align="right" class="formfield pad5"><button name="expbtn" type="submit">Save</button></td>
                </tr>
              </form>
              </table>
      ...
      <div>
        ...
        <div class="stitle">
          ...
          <div style="float: left;">
            <div>
              <input type="search" name="" class="searchfield" id="search" placeholder="Search farm expenses here..."  oninput="search()">
            </div>
          </div>
          <div style="display: flex; float: right;padding-bottom: 10px; background-color: white;">
            <button onclick="document.getElementById('modals').style.display='';" class="ybtn main-add no-border">Add Expenses</button>
          </div>
...
<script type="text/javascript">
  ...
  function search(){
    ...
    xml.open("GET","expensetbl.php?value="+val+"&userid="+userid+"&farm_id="+farmid);
    xml.send();
  }
