          ...
          <div>
            ...
            <div>
              ...
              <table>
                ...
                <td class="formfield"><label>FARMNAME: </label></td>
                <td class="formfield"><input class="memf" type="text" name="name" value="0" required=""></td>
                </tr>
                <tr>
                <td class="formfield"><label>FARM #: </label></td>
                <td class="formfield"><input class="memf" type="text" name="num" required=""></td>
                </tr>
                <tr>
                <td class="formfield"><label>AREA (Hectare): </label></td>
                <td class="formfield"><input class="memf" type="text" name="area" required=""></td>
                </tr>
                <tr>
                <td class="formfield"><label>FIELDS: </label></td>
                <td class="formfield"><input class="memf" type="number" min="1" name="fields" required=""></td>
                </tr>
                <tr>
                <td class="formfield"><label>LOCATION: </label></td>
                <td class="formfield"><input class="memf" type="text" name="loc" required=""></td>
                </tr>

                          

                <tr>
                  <td colspan="2" align="right" class="formfield pad5"><button name="mmb" type="submit">Save</button></td>
                </tr>
              </form>
              </table>
      ...
      <div>
        ...
        <div class="stitle">
          ...
          <div style="display: flex; float: right;padding-bottom: 10px; background-color: white;">
            <button onclick="document.getElementById('modals').style.display='';" class="ybtn main-add no-border">Add Farm</button>
          </div>
        ...
        <div style="margin-top: 10px;">
          <div id="inserhere">
           ...
           <div>
             <a href="actions/retrieve.php?link=afarm.php&table=farmtbl&column=user" onclick="return confirm('are you sure to proceed?')">Retrieved deleted data</a>
           </div>
          </div>
        </div>
      </div>
...
<script type="text/javascript">
  ...
  function search(){
    ...
    xml.open("GET","afarmtbl.php?value="+val+"&userid="+userid);
    xml.send();
  }
