                ...
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    ...
                    while($colx = getData($res)){
                      ...
                      if($stt==1){
                        $st1 = "bg-gradient-success";
                        $st2 = "VERIFIED";
                      }
                      else{
                        $st1 = "bg-gradient-danger";
                        $st2 = "PENDING";
                      }
                      $mid = $colx[0];
                      $flname1 = "'$flname'";
                      $contf = "'$cont'";
                      $addf = "'$addr'";
                      $aydi = "'includes/actions.php?act=$mid&type=ver'";
                      ...
                      <td>
                        <div class="d-flex px-2 py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm"><?php echo $flname; ?></h6>
                            <p class="text-xs text-secondary mb-0"><?php echo $colx[5]; ?></p>
                          </div>
                        </div>
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0"><?php echo $addr; ?></p>
                        <p class="text-xs text-secondary mb-0"><?php echo $cont?></p>
                      </td>
                      <td class="align-middle text-center text-sm">
                        <span class="badge badge-sm <?php echo $st1; ?>"><?php echo $st2; ?></span>
                      </td>
                      
                      <td class="align-middle">
                        <a href="javascript:;" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user" onclick="

                        document.getElementById('modax').style.display='';
                        document.getElementById('imahe').src = <?php echo $imgg; ?>;
                        document.getElementById('namef').innerHTML = <?php echo $flname1; ?>;
                        document.getElementById('contf').innerHTML = <?php echo $contf; ?>;
                        document.getElementById('addf').innerHTML = <?php echo $addf; ?>;
                        document.getElementById('ver').href = <?php echo $aydi; ?>;
                        ">
                          View
                        </a>
                      </td>
