            ...
            <div>
              <form method="post" action="../users/actions/admem.php?action=1">
                <table>
                  ...
                  <tr>
                    <td><textarea name="message" style="width: 500px;height: 300px;outline: none;"></textarea></td>
                  </tr>
                  <tr>
                    <td align="center" style="padding-top: 10px;">
                      <button type="submit" name="sms" class="savebtn">SAVE</button>
                    </td>
                  </tr>
                </table>
              </form>
        ...
        <div class="col-12">
          <div class="card mb-4">
            ...
            <div style="padding-left: 10px;">
              <button style="border-radius: 5px; border:solid 1px gray;" onclick="document.getElementById('modat').style.display='';">Add New announcement</button>
            </div>
              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    ...
                    $sql = "select * from sms where stat = 0";
                    $res = setQuery($sql);
                      ...
                      <td>
                        <div class="d-flex px-2 py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            ...
                            <p class="text-xs text-secondary mb-0"><a href="../users/actions/del.php?q=8&link=none&data=<?php echo $gid; ?>" style="color: red;">Delete</a></p>
                          </div>
                        </div>
                      </td>
